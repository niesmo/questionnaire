<?php $totalQuestionCount = count($questions);?>
<div class="container">
    <div class="row">
        <div class="col-md-12">
         <?php
            ...
            echo form_close();
            echo "<hr />";
            echo "<div><p class='search-stats'>{$totalQuestionCount} results found ({$elapsedSearchTime} seconds)<p></div>";
            ?>
            ...
            foreach($questions as $question){
                ...
                $content = highlight_phrase($content,$searchTerm, '<span style="background-color:yellow">','</span>');
